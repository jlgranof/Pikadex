...
const PokemonCard = ({ pokemon }) => {
  return (
    <div className='rounded-2xl border-gray-500 border-2 w-10/12 text-center items-center m-5 bg-gradient-to-tr from-slate-700 to-slate-200'>
      <NavLink to={`/pokemon/${pokemon.nationalPokedexNumber}`} style={{textDecoration: 'none'}}>
        ...
        <div className='bg-gradient-to-bl from-slate-700 to-slate-200 info-container-clip rounded-2xl border-t-4 border-b-2 border-x-2 text-white text-xl'>
